...
### 2. 몬스터 관련 로직
   ...
   - **몬스터 피격 및 디버프**
      ...
      - **몬스터 피격**
         ...
         - [Enemy Healthbar](https://github.com/DaeHyeokk/Poker-Tower-Defense/blob/a2d22a6b713ac10c1a7ee226d654f2d42d5bfd26/Assets/Scripts/Stage%20Scripts/Enemy%20Scripts/EnemyHealthbar.cs#L38-L66)는 Slider 오브젝트로 구현하였을 때 Enemy Prefab에 포함시킬 경우 Draw Call 한번에 하나의 Slider만 그리게 되어 오버헤드가 증가하는 문제가 있었기 때문에 Square 오브젝트로 구현하여 Draw Call을 최적화 하였다.
         - <details>
           <summary>코드 보기/숨기기</summary>
