...
public class RandomTowerCollectMission : NonRepeatMission
{
    ...
    private void SetMissionCompletionString()
    {
        ...
        {
            case 3:
                _missionCompletionString = "<color=\"white\">3시3끼 3겹살</color>\n";
                break;

            case 4:
                _missionCompletionString = "<color=\"white\">4각4각 4과</color>\n";
                break;

            case 5:
                _missionCompletionString = "<color=\"white\">5물5물 5징어</color>\n";
                break;
        }
    }
